export const PolicyContent: Record<string, string> = {
  "Regulamin": `
    <div class="space-y-8 text-text-secondary leading-relaxed text-left">
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 2 Postanowienia ogólne</h2>
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 3 Rejestracja i ochrona danych osobowych</h2>
        <ol class="list-decimal ml-6 space-y-3">
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 4 Ceny oraz opłaty za dostarczenie towarów</h2>
        <ol class="list-decimal ml-6 space-y-3">
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 5 Formy płatności</h2>
        <p class="mb-4">W sklepie internetowym Wydawnictwa OnUP możliwe są następujące formy płatności:</p>
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 6 Przyjmowanie i realizacja zamówień</h2>
        <ol class="list-decimal ml-6 space-y-3">
          <li>Zamówienia od Kupujących są przyjmowane, poprzez stronę <a href="http://www.on-up.pl" class="text-blue-600 hover:underline">www.on-up.pl</a>, 7 dni w tygodniu i 24 godziny na dobę. Informacje o towarach stanowią zaproszenie do zawarcia umowy w rozumieniu art. 71 Kodeksu Cywilnego.</li>
          ...
          <li>W przypadku, gdy czas realizacji byłby dłuższy niż podany powyżej lub na stronie <a href="http://www.on-up.pl" class="text-blue-600 hover:underline">www.on-up.pl</a>, Sprzedawca skontaktuje się z Kupującym, aby potwierdzić realizację zamówienia oraz uzgodnić ostateczny termin dostawy.</li>
        </ol>
      </section>

      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 7 Prawo odstąpienia od umowy i zasady zwrotów</h2>
        <ol class="list-decimal ml-6 space-y-3">
          ...
          <li>W przypadku odstąpienia od umowy, Kupujący zobowiązany jest do zwrotu otrzymanego towaru niezwłocznie, w terminie nie dłuższym niż 14 dni od dnia odstąpienia od umowy. Do zachowania tego terminu wystarczy wysłanie towaru przed jego upływem. Towar wraz z otrzymaną fakturą należy zwrócić na adres: Wydawnictwo OnUp; ul. Gajowa 14/2, 82-500 Rakowiec z dopiskiem: Zwrot – sklep internetowy Wydawnictwa On-Up</li>
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 8 Reklamacje</h2>
        <ol class="list-decimal ml-6 space-y-3">
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">§ 9 Postanowienia końcowe</h2>
        <ol class="list-decimal ml-6 space-y-3">
  ...
  "Dostawy i płatność": `
    <div class="space-y-8 text-text-secondary leading-relaxed text-left">
      ...
      <section>
        <h2 class="text-2xl font-bold mb-4 border-b pb-2 text-text-primary">JAK PAKUJEMY PRZESYŁKI (BEZPIECZEŃSTWO PRZESYŁKI)</h2>
  ...
  "Polityka prywatności": `
    <div class="space-y-8 text-text-secondary leading-relaxed text-left">
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary">Pozyskiwanie danych</h3>
        <p>Twoje dane otrzymaliśmy od Ciebie podczas dobrowolnego zakładania konta na naszej stronie internetowej <a href="http://www.on-up.pl" class="text-blue-600 hover:underline">www.on-up.pl</a>. Podstawowym sposobem pozyskiwania danych osobowych jest dobrowolne wypełnienie formularza. Administrator pozyskuje w ten sposób imię, nazwisko, adres, numer telefonu oraz adres e-mail użytkownika, który będzie loginem.</p>
        <p class="mt-4">Podanie danych osobowych jest dobrowolne, jednakże brak zgody na ich przetwarzanie przez nas może uniemożliwić nam świadczenie Tobie usług drogą elektroniczną oraz dokonywanie przez Ciebie zakupów w sklepie internetowym on-up.pl.</p>
        <p class="mt-4">Login i hasło są poufnymi danymi zabezpieczającymi Twoje konto przed nieuprawnioną ingerencją osób trzecich, dlatego zobowiązujesz się do nieudostępniania tych danych osobom postronnym.</p>
      </section>

      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary">Cel przetwarzania</h3>
        <p>Przetwarzanie Twoich danych pozwala nam na świadczenie usług przez księgarnię internetową działającą pod adresem <a href="http://www.on-up.pl" class="text-blue-600 hover:underline">www.on-up.pl</a>, w szczególności na utrzymaniu konta, realizowaniu Twoich zamówień, kontaktów związany z wykonywaniem umowy sprzedaży, a także przesyłaniu informacji o nowościach w postaci newslettera.</p>
      </section>

      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary">Okres przechowywania</h3>
      ...
      <section>
        ...
        <p class="mt-2 bg-bg-primary p-4 border rounded italic">
          ...
          ul. Gajowa 14/2<br>
          82-500 Rakowiec<br>
          e-mail: <a href="mailto:onup.wydawnictwo@gmail.com" class="text-blue-600 hover:underline">onup.wydawnictwo@gmail.com</a>
        </p>
      </section>

      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary">Podmioty zewnętrzne</h3>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary">Pliki cookies</h3>
        <p>W celu zapewnienia wysokiej jakości usług, zapamiętywania ustawień i preferencji klienta oraz gromadzenia anonimowych informacji związanych z korzystaniem ze stron naszego sklepu <a href="http://www.on-up.pl" class="text-blue-600 hover:underline">www.on-up.pl</a> wykorzystujemy pliki cookies (tzw. ciasteczka). Korzystając z naszych stron wyrażasz zgodę na wykorzystywanie plików cookies.</p>
        <p class="mt-4">Możesz wyłączyć ten mechanizm w dowolnym momencie w ustawieniach swojej przeglądarki internetowej. Korzystanie z naszego sklepu bez zmiany ustawień dotyczących cookies oznacza, że będą one zapisane w pamięci Twojego urządzenia (informacje na temat sesji, ostatnio oglądanych produktów, produktów w koszyku itp.).</p>
      </section>

      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary">Twoje prawa</h3>
        ...
        <p class="mt-4">Osoba, której dane dotyczą, ma prawo wniesienia skargi do Prezesa Urzędu Ochrony Danych Osobowych, gdy uzna, iż przetwarzanie jej danych osobowych narusza przepisy RODO (Rozporządzenie o Ochronie Danych Osobowych). Podanie danych osobowych jest dobrowolne.</p>
        <p class="mt-4">Jeśli uważasz, że przetwarzając Twoje dane naruszamy Twoje prawa skontaktuj się z nami.</p>
      </section>
  ...
  "Polityka zwrotów": `
    <div class="space-y-8 text-text-secondary leading-relaxed text-left">
      <section>
        ...
        <p class="mt-4">Jeżeli oświadczenie zostanie przysłane za pośrednictwem poczty elektronicznej (e-mail) Sprzedawca niezwłocznie przesyła Kupującemu potwierdzenie otrzymania oświadczenia o odstąpieniu od umowy.</p>
      </section>

      <section>
        <p>Odstąpienie od umowy może dotyczyć wszystkich towarów objętych zamówieniem albo ich części.</p>
      </section>
      ...
      <section>
        ...
        <p class="mt-4 bg-bg-primary p-4 border rounded italic">
          ...
          ul. Gajowa 14/2,<br>
          82-500 Rakowiec<br>
          <span class="font-bold">z dopiskiem: Zwrot – sklep Wydawnictwo On-Up</span>
        </p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary uppercase">Zwrot płatności</h3>
      ...
      <section>
        ...
        <p class="mt-4">Uprawnienie do odstąpienia od umowy nie wyłącza uprawnień Kupującego wynikających z odpowiedzialności Sprzedawcy za wady towaru oraz gwarancji producenta.</p>
      </section>
    </div>
  `,
  "O nas": `
    <div class="space-y-8 text-text-secondary leading-relaxed text-left">
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary uppercase">Działalność</h3>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-text-primary uppercase">Sklep internetowy</h3>
      ...
      <section>
        ...
        <div class="bg-bg-primary p-6 border rounded-lg italic space-y-1">
          ...
          <div class="pt-4 not-italic font-medium space-y-1">
            <p>tel. <span class="text-text-primary">506 610 405</span></p>
            <p>e-mail: <a href="mailto:onup.wydawnictwo@gmail.com" class="text-blue-600 hover:underline">onup.wydawnictwo@gmail.com</a></p>
          </div>
        </div>
      </section>
