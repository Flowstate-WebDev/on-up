...
export function CategoryHeading({ children }: Props) {
  return (
    <div className="flex items-center justify-center gap-2 md:gap-8 px-2">
      ...
      />
      <h1 className="uppercase font-extrabold text-text-obj text-base sm:text-lg md:text-3xl bg-bg-tertiary rounded-lg p-2 px-3 md:px-4 w-fit whitespace-nowrap">
        {children}
      </h1>
      <img
